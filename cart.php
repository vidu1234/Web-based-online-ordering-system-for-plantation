  ...
  ?>
						<table class="tblone">
							...
							<tr>
								...
								<td style="text-align:center;">Rs.<?php echo $result['price'].".00"; ?></td>
								<td>
						...
						<table style="float:right;text-align:left;" width="50%">
							<tr>								
								...
								<td>Rs.<?php echo number_format($sum).".00"; ?></td>
					...
					<div class="shopping">
						...
						<div class="shopright">
							<a href="payment.php"><button class="pay-btn">Checkout</button> </a>
