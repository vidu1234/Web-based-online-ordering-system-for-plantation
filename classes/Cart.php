...
class Cart
{
    ...
    {
        $query = "SELECT * FROM tbl_order WHERE price BETWEEN 500 AND 600 ";
        $result = $this->db->select($query);
        return $result;
    }
    ...
    {
        $query = "SELECT COUNT(id) as 'sumorder' from tbl_order";
        $result = $this->db->select($query);
        return $result;
    }

    public function getshifetedOrderTotal()
    {
        $query = "SELECT COUNT(id) as 'shiftedorder' from tbl_order where status ='0' ";
        $result = $this->db->select($query);
        return $result;
    }

     public function getpendingOrderTotal()
    {
        $query = "SELECT COUNT(id) as 'pendingorder' from tbl_order where status ='1' ";
        $result = $this->db->select($query);
        return $result;
    }
    public function getincomeTotal()
    {
        $query = "SELECT SUM(price) as 'sumincome' from tbl_order";
        $result = $this->db->select($query);
        return $result;
    }
